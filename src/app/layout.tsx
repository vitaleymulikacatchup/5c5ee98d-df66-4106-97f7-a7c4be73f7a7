...
export const metadata: Metadata = {
  ...
  description: "Celebrate Anish's special day with us!",
  openGraph: {
    title: "Anish's Birthday Party",
    description: "Join us to celebrate Anish's special day!",
    url: "http://example.com",
    siteName: "Anish's Birthday Celebration",
    images: [
      {
        url: "https://images.pexels.com/photos/2072181/pexels-photo-2072181.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    images: ["https://images.pexels.com/photos/2072181/pexels-photo-2072181.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
